...
div.browse {
  ...
  div.header {
    padding: 10px 10px 9px; text-align: left; background: @bg url('/page/images/panel_header_bg.png') repeat-x top left;
    ...
    span.filter {
      ...
      a {
        ...
        text-transform: uppercase; background: url('/page/images/transparent_backgrounds/black_50.png'); color: @light_grey; text-decoration: none; position: relative; z-index: 3;
        .active {
      ...
      ul {
        ...
        li {
          ...
          a {
            ...
            :hover { background: url('/page/images/transparent_backgrounds/accent_colour_25.png'); color: @black; }
          }
          :last-child {
            a { border: none; }
          }
  ...
  > ul {
    ...
    li {
      ...
      div.thumbnail {
        ...
        .marker {
          ...
          background: url('/page/images/transparent_backgrounds/white_75.png'); height: 12px; width: 12px;
        }
        .marker.coupon {
    ...
    li.paginate {
      ...
      a {
        ...
        div.arrow {
          background: #81c153 url('/page/images/button_bg.png') repeat-x left top; border: 1px solid (@accent_colour * 0.75 + @black * 0.25);
        ...
        :hover {
          div.arrow { background: #abd56e url('/page/images/button_bg.png') repeat-x left -44px; }
        }
      }
  ...
  > ul {
    ...
    > li {
      ...
      .marker {
        ...
        background: url('/page/images/transparent_backgrounds/white_75.png');
...
div.panel {
  ...
  > div.header {
    background: @bg url('/page/images/panel_header_bg.png') repeat-x top left; border-bottom: 1px solid (@bg * 0.66 + @black * 0.33);
...
#sidebar {
  #actions {
    ...
    div.content {
      background: url('/page/images/transparent_backgrounds/accent_colour_10.png'); text-align: center;
      p.endorsement {
...
/* List Numbers */
label.list_number {
  float: left; background: url('/page/images/transparent_backgrounds/black_15.png'); padding: 2px; width: 24px; height: 24px; display: block;
  .border_radius(99);
  b {
      ...
      div.header {
        ...
        ul.tabs {
          ...
          li {
            margin: 0 5px 0 0;
            a {
              border: none; background: url('/page/images/transparent_backgrounds/white_75.png');
              :hover { color: @black; }
            }
          }
          li.active {
...
#dashboard_nav {
  ...
  li {
    ...
    a {
      ...
      text-decoration: none; color: @white; background: url('/page/images/transparent_backgrounds/accent_colour_30.png'); font-size: 14px;
      font-weight: bold;
      :hover { background: url('/page/images/transparent_backgrounds/accent_colour_45.png'); }
    }
  }
  li.active {
    a {
